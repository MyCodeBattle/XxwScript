...
- **状态文本**：实时显示当前动作，例如：
  ...
  - `submitted 2026-05-05 12:46:49..2026-05-05 23:59:59 task=3817396224571605464 | 等待文件生成 | 导出间隔 181s`
  - `downloaded 2026-04-29 00:00:00..2026-04-29 11:59:59`
- **事件日志**：`split`、`downloaded`、`failed` 等关键事件单独输出一行到终端；`submitted` 作为主状态行起点持续刷新，不再单独打印历史日志
- **完成/失败**：结束时输出最终状态并换行
